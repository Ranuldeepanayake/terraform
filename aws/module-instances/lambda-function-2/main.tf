...
module "lambda" {
  ...
  description            = "Lambda function which returns the health status of the Lambda function and the environment it is running in."
  runtime                = "nodejs24.x"
  ...
  environment_variables = {
    ...
    USER1_PASSWORD = "alice@123"
    USER1_ID       = "1001"
    USER1_ROLE     = "admin"

    USER2_USERNAME = "bob"
    USER2_PASSWORD = "bob@123"
    USER2_ID       = "1002"
    USER2_ROLE     = "user"
  }
