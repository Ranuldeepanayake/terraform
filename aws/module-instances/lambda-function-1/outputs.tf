...
output "lambda_created_custom_policy_arns" {
  ...
  value       = module.lambda.lambda_created_custom_policy_arns
}
...
output "lambda_existing_custom_policy_arns" {
  ...
  value       = module.lambda.lambda_existing_custom_policy_arns
}
...
output "lambda_all_custom_policy_arns" {
  ...
  value       = module.lambda.lambda_all_custom_policy_arns
}
